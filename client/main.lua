...
function setUniform(job, playerPed)
  TriggerEvent('skinchanger:getSkin', function(skin)
    ...
    if skin.sex == 0 then
      ...
      if job ~= 'citizen_wear' and job ~= 'brasseur_outfit' then
...
function OpenCloakroomMenu()
  ...
  local elements = {
    ...
    { label = _U('brasseur_outfit'),    value = 'brasseur_outfit'},
  }
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'brasseur_outfit' then
    ...
    function(data, menu)
      ...
      if player ~= -1 and distance <= 3.0 then
        ...
        if amount == nil then
            ...
            TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_brasseur', _U('billing'), amount)
        end
...
ESX.TriggerServerCallback('esx_brasseriejob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_brasseriejob:putStockItems', itemName, count)
            end
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_brasseriejob:getVaultWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_brasseriejob:removeVaultWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_brasseriejob:addVaultWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
...
AddEventHandler('esx_brasseriejob:hasEnteredMarker', function(zone)
    ...
    CurrentAction     = 'houblon_harvest'
    CurrentActionMsg  = _U('press_collect')
    CurrentActionData = {zone= zone}
  end
    
  if zone == 'TraitementBrune' then
    CurrentAction     = 'brune_traitement'
    CurrentActionMsg  = _U('press_brune')
    CurrentActionData = {zone= zone}
  end  

  if zone == 'TraitementBlonde' then
    CurrentAction     = 'blonde_traitement'
    CurrentActionMsg  = _U('press_blonde')
    CurrentActionData = {zone= zone}
  end   
...
AddEventHandler('esx_brasseriejob:hasExitedMarker', function(zone)
    ...
    while true do
        ...
        if IsJobTrue() then
            ...
            if (isInMarker and not HasAlreadyEnteredMarker) or (isInMarker and LastZone ~= currentZone) then
                ...
                TriggerEvent('esx_brasseriejob:hasEnteredMarker', currentZone)
            end

            if not isInMarker and HasAlreadyEnteredMarker then
                HasAlreadyEnteredMarker = false
                TriggerEvent('esx_brasseriejob:hasExitedMarker', LastZone)
            end
...
AddEventHandler('esx_brasseriejob:hasExitedMarker', function(zone)
  ESX.UI.Menu.CloseAll()
  if (zone == 'HoublonFarm') and PlayerData.job ~= nil and PlayerData.job.name == 'brasseur' then
    TriggerServerEvent('esx_brasseriejob:stopHarvest')
  end  
  if (zone == 'TraitementBrune' or zone == 'TraitementBlonde') and PlayerData.job ~= nil and PlayerData.job.name == 'brasseur' then
    TriggerServerEvent('esx_brasseriejob:stopTransform')
  end
  if (zone == 'SellFarm') and PlayerData.job ~= nil and PlayerData.job.name == 'brasseur' then
    TriggerServerEvent('esx_brasseriejob:stopSell')
  end
  CurrentAction = nil
end)
  ...
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlJustReleased(0,  Keys['E']) and IsJobTrue() then
          ...
          if CurrentAction == 'houblon_harvest' then
          TriggerServerEvent('esx_brasseriejob:startHarvest', CurrentActionData.zone)
        end
        if CurrentAction == 'brune_traitement' then
          TriggerServerEvent('esx_brasseriejob:startTransform', CurrentActionData.zone)
        end
        if CurrentAction == 'blonde_traitement' then
          TriggerServerEvent('esx_brasseriejob:startTransform', CurrentActionData.zone)
        end
        if CurrentAction == 'farm_resell' then
          TriggerServerEvent('esx_brasseriejob:startSell', CurrentActionData.zone)
        end
    ...
    if IsControlJustReleased(0,  Keys['F6']) and IsJobTrue() and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'brasseur_actions') then
